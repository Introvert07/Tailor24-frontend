  ...
  return (
    <Link to={to}
      style={{ fontFamily: 'Raleway, sans-serif', fontSize: 13,
        color: 'rgba(212,188,148,0.5)', textDecoration: 'none', transition: 'color 0.25s' }}
      onMouseEnter={e => e.currentTarget.style.color = '#C9972A'}
      onMouseLeave={e => e.currentTarget.style.color = 'rgba(212,188,148,0.5)'}>
      {children}
    </Link>
  );
}
...
function ColLabel({ text }) {
  return (
    <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: 9, letterSpacing: 5,
      color: 'rgba(201,151,42,0.6)', textTransform: 'uppercase',
...
export default function Footer() {
  return (
    <footer style={{ background: '#2D0202', position: 'relative', overflow: 'hidden' }}>
      <style>{fonts}{`
      ...
      {/* Ambient glow - tuned for Maroon */}
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none',
        background: 'radial-gradient(ellipse 80% 50% at 50% 110%, rgba(201,151,42,0.08) 0%, transparent 60%)' }} />

      {/* Top rule */}
      <div style={{ height: 1, background: 'linear-gradient(90deg,transparent,rgba(201,151,42,0.3) 25%,rgba(201,151,42,0.3) 75%,transparent)' }} />
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '72px 24px 0' }}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          className="hero-flex"
          style={{ paddingBottom: 56, borderBottom: '1px solid rgba(201,151,42,0.1)' }}>
          ...
          <div className="hero-text">
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20, justifyContent: 'inherit' }}>
              ...
              <span style={{ fontFamily: 'Raleway, sans-serif', fontSize: 9, letterSpacing: 6,
                color: 'rgba(201,151,42,0.6)', textTransform: 'uppercase' }}>Est. 2004 · Madhya Pradesh</span>
            </div>
            ...
            <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: 12, letterSpacing: 5,
              color: 'rgba(201,151,42,0.5)', fontStyle: 'italic', marginTop: 12 }}>
              Crafted for You
            </p>
          </div>
          ...
          <div style={{ maxWidth: 460 }} className="hero-text">
            <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: 14,
              color: 'rgba(244,232,208,0.6)', lineHeight: 1.9, fontWeight: 300, marginBottom: 28 }}>
              Traditional craft. Modern speed. Bespoke garments delivered in 24 hours —
              across three showrooms in Madhya Pradesh.
            </p>
            <Link to="/catalog"
              style={{ display: 'inline-flex', alignItems: 'center', gap: 10,
                fontFamily: 'Raleway, sans-serif', fontSize: 10, letterSpacing: 4, fontWeight: 700,
                textTransform: 'uppercase', color: '#2D0202', background: '#C9972A',
                padding: '16px 36px', textDecoration: 'none', transition: 'all 0.3s ease' }}
              onMouseEnter={e => {
                  e.currentTarget.style.background = '#E5B74D';
        ...
        <div className="ft-grid">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            ...
            <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: 13,
              color: 'rgba(212,188,148,0.5)', lineHeight: 1.85, fontWeight: 300, marginBottom: 28 }}>
              ...
              {CITIES.map(c => (
                <div key={c} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <span style={{ fontFamily: 'Raleway, sans-serif', fontSize: 12,
                    color: 'rgba(201,151,42,0.5)', letterSpacing: 2 }}>{c}</span>
                </div>
              ))}
            </div>
          </motion.div>
              ...
              {[
                ...
                <a key={text} href={href}
                  style={{ display: 'flex', gap: 12, alignItems: 'center',
                    color: 'rgba(212,188,148,0.5)', textDecoration: 'none' }}>
                  <Icon size={13} style={{ flexShrink: 0, color: 'rgba(201,151,42,0.6)' }} />
                  <span style={{ fontFamily: 'Raleway, sans-serif', fontSize: 13 }}>{text}</span>
                </a>
              ))}
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              <motion.a href="#" whileHover={{ scale: 1.1, backgroundColor: 'rgba(201,151,42,0.1)' }}
                style={{ width: 40, height: 40, border: '1px solid rgba(201,151,42,0.3)',
      ...
      {/* ── Bottom bar ── */}
      <div style={{ borderTop: '1px solid rgba(201,151,42,0.1)', background: 'rgba(0,0,0,0.15)' }}>
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '32px 24px' }} className="bottom-bar">
          <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: 11, color: 'rgba(201,151,42,0.4)', letterSpacing: 1 }}>
            © {new Date().getFullYear()} Tailor 24. All rights reserved.
          </p>
          <p style={{ fontFamily: 'Raleway, sans-serif', fontSize: 11, color: 'rgba(201,151,42,0.4)', fontStyle: 'italic' }}>
