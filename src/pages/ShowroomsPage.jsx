...
const ArchWrapper = ({ children }) => (
  <div className="relative overflow-hidden" style={{ borderRadius: '120px 120px 0 0' }}>
    {children}
  </div>
);
...
export default function ShowroomsPage() {
  ...
  return (
    <div className="min-h-screen pb-24" style={{ backgroundColor: C.page }}>
      ...
      {/* Hero Header */}
      <header className="relative pt-32 pb-20 overflow-hidden" style={{ backgroundColor: C.parchment }}>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 text-center relative z-10">
          <motion.span 
            ...
            className="font-sans text-[10px] uppercase tracking-[0.6em] mb-4 block" 
            style={{ color: C.gold }}
          >
            Regional Presence
          </motion.span>
          ...
          <div className="w-24 h-[1px] bg-gold-600 mx-auto mb-6 opacity-30" style={{ backgroundColor: C.gold }} />
          <p className="font-sans text-sm text-charcoal/60 max-w-xl mx-auto leading-relaxed italic">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 -mt-8 relative z-20">
        ...
        <div className="flex justify-center mb-16">
          <div className="inline-flex bg-white/80 backdrop-blur-md p-1.5 shadow-xl shadow-maroon-900/5 rounded-full border" style={{ borderColor: C.border }}>
            {CITIES.map(city => (
              <button
                key={city}
                onClick={() => dispatch(setActiveCity(city))}
                className="relative px-8 py-2.5 rounded-full transition-all duration-300"
              >
                <span className={`relative z-10 font-sans text-[10px] font-bold uppercase tracking-widest transition-colors ${
            ...
            <AnimatePresence mode="popLayout">
              {filtered.map((showroom, i) => (
                <motion.div
                  ...
                  className="group bg-white border border-transparent hover:border-gold-500/30 transition-all duration-500 shadow-sm hover:shadow-2xl"
                ...
                >
                    ...
                    <ArchWrapper>
                      <div className="aspect-[4/5] overflow-hidden bg-cream-200 relative">
                        ...
                        <div className="absolute top-6 left-6 flex items-center gap-2 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full">
                          ...
                          <span className="font-sans text-[9px] font-bold uppercase tracking-tighter" style={{ color: C.ink }}>
                            {showroom.isActive ? 'Accepting Appointments' : 'Closed'}
                          </span>
                        </div>
                        
                        <div className="absolute bottom-6 left-0 w-full text-center">
                           <p className="font-display text-white text-2xl italic tracking-wide">{showroom.city}</p>
                        </div>
                      </div>
                    </ArchWrapper>
                  </div>
                  ...
                  <div className="p-8 text-center">
                    ...
                    <h3 className="font-display text-2xl mb-4 group-hover:text-maroon-800 transition-colors" style={{ color: C.ink }}>
                      {showroom.name}
                    </h3>
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="flex items-start justify-center gap-3">
                        ...
                        <p className="font-sans text-xs leading-relaxed opacity-60 max-w-[200px]">{showroom.address}</p>
                      </div>
                      
                      <div className="flex items-center justify-center gap-3">
                        <FiClock size={14} style={{ color: C.gold }} />
                        <p className="font-sans text-[11px] uppercase tracking-wider opacity-60">11:00 AM — 09:00 PM</p>
                      </div>
                    ...
                    <a
                      ...
                      className="group/btn relative inline-flex items-center gap-3 px-8 py-3 overflow-hidden border transition-all"
                    ...
                    >
                      ...
                      <span className="relative z-10 font-sans text-[10px] font-bold uppercase tracking-[0.2em] group-hover/btn:text-white">
                        Connect with Studio
                      </span>
                    </a>
                  </div>
      ...
      <div className="mt-20 flex justify-center opacity-10">
          <div className="w-40 h-20 border-t-2 border-l-2 border-r-2 rounded-t-full" style={{ borderColor: C.gold }} />
      </div>
    </div>
  );
}